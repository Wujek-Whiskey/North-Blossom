      ...
      <header className={styles.wrapper}>
        <div className={styles.wrapper__content}>
          <p className={styles.content__text}>
            Cześć, Mam na imię Kamil. Kreatywny sposób podejścia do pracy to
            moja specjalność. Z wielkim entuzjazmem podchodze do tworzenia
            identyﬁkacji wizualnej marki.
          </p>
